...
class FeloginHook
{
    ...
    /**
     * @param array $params
     * @param FrontendLoginController $pObj
     */
    public function postProcContent(array $params, FrontendLoginController $pObj)
    {
        ...
        if (empty($settings['oidcClientKey'])
            ...
            if (empty($_SESSION['requestId']) || $_SESSION['requestId'] !== $requestId) {
                ...
                $_SESSION['oidc_redirect_url'] = GeneralUtility::_GP('redirect_url') ?? GeneralUtility::getIndpEnv('HTTP_REFERER') ?? '';
